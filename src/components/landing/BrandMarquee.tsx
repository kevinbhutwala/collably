...
export function BrandMarquee() {
  ...
  return (
    <section className="py-10 border-y border-white/10 bg-[#0c080e] overflow-hidden text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3 text-center md:text-left">
            <div className="w-9 h-9 rounded-xl bg-white/[0.05] border border-white/10 text-white flex items-center justify-center shrink-0 shadow-xs">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {integrations.map((item, idx) => (
              <div
                key={idx}
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.04] border border-white/10 text-xs font-medium text-slate-200 shadow-xs"
              >
          ...
          <Link
            href="/for-brands"
            className="inline-flex items-center gap-1 text-xs font-bold text-[hsl(327,100%,55%)] hover:text-pink-300 transition-colors shrink-0 font-display"
          >
