...
export function CaseStudiesSection() {
  return (
    <section className="py-24 border-t border-black/8 bg-[#FAFAFC] text-[#0A0A0E] select-none font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[#FFD21F]/20 border border-[#FFD21F]/40 text-[#0A0A0E] text-xs font-semibold font-mono shadow-xs">
            <ShieldCheck className="w-3.5 h-3.5 text-[#0A0A0E]" />
            <span>The Collably Trust &amp; Escrow Guarantee</span>
          </div>
          <h2 className="text-3xl sm:text-5xl font-extrabold text-[#0A0A0E] tracking-tight font-display">
            How Collably Protects Both Sides
          </h2>
          <p className="text-base text-[#5A5A68] font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            className="rounded-3xl bg-white border border-black/8 p-8 sm:p-10 shadow-sm hover:border-[#FFD21F] hover:shadow-[0_12px_40px_rgba(255,210,31,0.18)] transition-all flex flex-col justify-between space-y-8 relative overflow-hidden group hover-lift"
          >
            ...
            <div className="space-y-6 relative z-10">
              <div className="flex items-center justify-between">
                <div className="p-3.5 rounded-2xl bg-[#FFFDF5] border border-[#FFD21F]/30 text-[#0A0A0E] shadow-xs">
                  <Lock className="w-6 h-6 text-[#0A0A0E]" />
                </div>
                <span className="px-3 py-1 rounded-full bg-black/5 border border-black/10 text-[#0A0A0E] text-xs font-mono font-bold uppercase">
                  Brand Protection
                </span>
              </div>

              <div>
                <h3 className="text-2xl font-extrabold text-[#0A0A0E] font-display">
                  Zero Upfront Release Risk
                </h3>
                <p className="text-sm text-[#5A5A68] mt-2 leading-relaxed font-sans">
            ...
            <div className="pt-6 border-t border-black/8 flex items-center justify-between relative z-10">
              <span className="text-xs text-[#7A7A8A] font-mono">10% flat transparent fee</span>
              <Link href="/app/brand/campaigns/create">
                <button className="px-6 py-2.5 rounded-full bg-[#0A0A0E] hover:bg-[#20202B] text-white text-xs font-bold transition-all flex items-center gap-1.5 shadow-xs hover-lift">
          ...
          >
            ...
            <div className="space-y-6 relative z-10">
              <div className="flex items-center justify-between">
                ...
                <span className="px-3 py-1 rounded-full bg-[#FFD21F]/20 border border-[#FFD21F]/40 text-[#0A0A0E] text-xs font-mono font-bold uppercase">
                  Creator Protection
                </span>
              </div>
            ...
            <div className="pt-6 border-t border-black/8 flex items-center justify-between relative z-10">
              <span className="text-xs text-[#7A7A8A] font-mono">Keep 90% of verified earnings</span>
