...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col justify-center items-center pt-24 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-transparent">
      {/* Background Subtle Warm Sunset Radial Glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] sm:w-[1100px] h-[500px] bg-gradient-radial from-orange-200/50 via-rose-200/30 to-transparent blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-orange-50 via-rose-50 to-pink-50 border border-orange-200/80 text-xs font-mono text-slate-700 shadow-sm"
        >
        ...
        <div className="space-y-2 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 leading-[1.08] select-none font-sans">
            {words.map((word, idx) => {
                ...
                <span key={idx} className="inline-block overflow-hidden mr-2.5 sm:mr-4 py-1">
                  <motion.span
                    ...
                    className={`inline-block ${
                      isHighlight
                        ? "bg-gradient-to-r from-brand-accent via-rose-500 to-amber-500 bg-clip-text text-transparent"
                        : "text-slate-900"
                    }`}
                  >
                    {word}
