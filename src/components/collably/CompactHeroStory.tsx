...
const HERO_CREATORS: HeroCreator[] = [
  {
    ...
    tag: "Contemporary Fashion & Style",
  ...
  },
  {
    ...
    tag: "Aesthetic Studio & Desk Tech",
    bio: "Tech and workspace aesthetics. Designing calm, functional creative studios and desk ergonomics.",
  },
  {
    id: "daniel",
    name: "Daniel Titchener",
    handle: "@daniel_titchener",
    niche: "Minimalist Architecture & Workspaces",
    matchScore: "99.1%",
    reach: "95K",
    rate: "$520",
    rateAmount: 520,
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&auto=format&fit=crop&q=80",
    tag: "Architectural Studio Curator",
    bio: "Architectural designer exploring intentional spaces, desk setups, and mindful tools for thought.",
  },
];
