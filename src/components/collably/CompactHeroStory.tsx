...
const HERO_CREATORS: HeroCreator[] = [
  {
    ...
    rate: "$3,500",
    rateAmount: 3500,
    image: "/creators/sara-dietschy.jpg",
  ...
  },
  {
    ...
    tag: "8K Cinema Tech Reviews",
    bio: "Preeminent technology reviewer evaluating flagship smartphones, electric vehicles, and computing hardware.",
  },
  {
    id: "peter",
    name: "Peter McKinnon",
    handle: "@petermckinnon",
    niche: "Cinematography & Photography",
    matchScore: "99.1%",
    reach: "5.9M",
    rate: "$8,500",
    rateAmount: 8500,
    image: "/creators/peter-mckinnon.jpg",
    tag: "Cinematic Visual Storyteller",
    bio: "Filmmaker and photographer sharing camera masterclasses and high-production visual journeys.",
  },
];
