  ...
  return (
    <section className="relative min-h-[92vh] lg:min-h-[105vh] bg-[#FAFAF8] border-b border-[#E7E7E4] overflow-hidden pt-6 pb-20 sm:pb-32 select-none text-[#111111]">
      ...
      <div className="absolute top-12 sm:top-6 inset-x-0 flex justify-center pointer-events-none z-0 opacity-[0.03] select-none overflow-hidden">
        <span className="text-[20vw] font-extrabold tracking-tighter leading-none font-display text-[#111111]">
          COLLABLY
        </span>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12 lg:space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 pt-2 sm:pt-6">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold text-[#111111] tracking-tight leading-[1.04] font-display">
            ...
            <div className="h-10 sm:h-12 flex items-center justify-center overflow-hidden">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="font-mono text-xs sm:text-sm font-bold uppercase tracking-widest text-[#111111] flex items-center gap-2 bg-[#B7FF3C] px-3 py-1 rounded-md shadow-xs"
                >
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#6B6B6B] font-sans max-w-xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
            <Link
              href="/for-brands"
              className="w-full sm:w-auto px-8 py-3.5 rounded-[9px] bg-[#111111] hover:bg-[#262626] active:bg-[#000000] text-[#FAFAF8] font-semibold text-sm shadow-xs transition-all flex items-center justify-center gap-2 font-sans group"
            >
            ...
            <Link
              ...
              className="w-full sm:w-auto px-7 py-3.5 rounded-[9px] bg-[#FFFFFF] hover:bg-[#F4F4F0] border border-[#E7E7E4] text-[#111111] font-semibold text-sm shadow-xs transition-all flex items-center justify-center gap-2 font-sans"
            >
        ...
        <div className="relative w-full max-w-6xl mx-auto min-h-[580px] sm:min-h-[720px] lg:min-h-[820px] mt-8 select-none">
          {/* Background Chrome Gradient Ambient Surface */}
          <div className="absolute inset-x-8 top-12 bottom-12 rounded-3xl bg-gradient-to-b from-[#FFFFFF] via-[#F4F4F0] to-transparent border border-[#E7E7E4] pointer-events-none -z-10 shadow-xs" />

          {/* ── 01. OVERSIZED EDITORIAL ARTWORK WORD "CREA" ── */}
          <div className="absolute top-2 sm:top-6 left-0 sm:left-4 z-0 pointer-events-none">
            <span className="text-6xl sm:text-8xl lg:text-9xl font-black text-[#111111]/[0.06] tracking-tighter font-display leading-none">
              CREA
            </span>
          </div>
          ...
          >
            <div className="relative aspect-[4/5] w-full overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-white text-xs font-mono">
                <div>
                  <h3 className="font-bold font-sans text-sm text-[#FAFAF8]">{maleHero.name}</h3>
          ...
          >
            <div className="relative aspect-[3/4] w-full overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-4 text-[#FAFAF8] text-xs font-mono">
                <span className="text-[10px] text-[#B7FF3C] uppercase font-bold block">EDITORIAL PARTNER</span>
          ...
          <div className="absolute bottom-4 sm:bottom-8 right-2 sm:right-8 z-30 pointer-events-none">
            <span className="text-5xl sm:text-7xl lg:text-9xl font-black text-[#111111]/[0.06] tracking-tighter font-display leading-none">
              GET PAID.
            </span>
          </div>
          ...
          >
            <div className="flex items-center justify-between gap-2 pb-1.5 border-b border-[#E7E7E4] text-xs font-mono">
              <span className="font-bold text-[#111111] font-sans truncate">Elena Rostova</span>
          ...
          >
            ...
            <div className="flex items-baseline justify-between">
              <span className="text-xl sm:text-2xl font-extrabold font-mono text-[#111111]">
                ₹18,500
              </span>
          ...
          >
            ...
            <div className="font-mono text-xs">
              <div className="flex items-center gap-1.5">
                <span className="font-bold text-[#111111] font-sans">TECH LAUNCH</span>
          ...
          {/* ── 09. FICTIONAL EDITORIAL BRAND LABELS ── */}
        ...
        <div className="pt-4 sm:pt-6 border-t border-[#E7E7E4] flex flex-wrap items-center justify-between gap-4 text-xs font-mono text-[#6B6B6B]">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[#111111] font-semibold">&lt; 24h Automated Creator Payouts</span>
          </div>
          <div className="flex items-center gap-2">
            <Lock className="w-4 h-4 text-[#111111]" />
            <span className="text-[#111111] font-semibold">10% Flat Take-Rate (90% Creator Net)</span>
          </div>
        </div>
      </div>
    </section>
