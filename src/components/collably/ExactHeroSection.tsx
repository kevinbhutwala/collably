        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-6 items-center min-h-[75vh]">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-8">
            ...
            <div className="inline-flex items-center gap-2">
              <span className="text-[11px] sm:text-xs font-mono font-bold tracking-[0.18em] text-[#5A5A68] uppercase">
          ...
          <div className="lg:col-span-6 relative min-h-[460px] sm:min-h-[580px] flex items-center justify-center">
            ...
            <motion.div
              ...
              className="relative z-10 w-60 sm:w-72 md:w-80 rounded-3xl overflow-hidden border-2 border-white shadow-[0_20px_50px_rgba(0,0,0,0.12)] -translate-x-6 sm:-translate-x-12"
            >
            ...
            {/* 2. Secondary Male Creator Portrait */}
            <motion.div
              initial={{ opacity: 0, x: 30, y: 30 }}
              animate={{ opacity: 1, x: 0, y: 0 }}
              transition={{ duration: 0.7, delay: 0.15 }}
              className="absolute z-20 top-6 right-2 sm:right-6 w-44 sm:w-56 rounded-2xl overflow-hidden border-2 border-white shadow-[0_15px_35px_rgba(0,0,0,0.1)]"
            >
            ...
            {/* 3. Small Vertical Video Card (Far Right) */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.25 }}
              className="hidden sm:block absolute z-30 bottom-8 right-0 w-36 sm:w-40 rounded-2xl overflow-hidden border border-black/8 bg-white shadow-xl p-2 space-y-2"
            >
