  ...
  return (
    <section className="py-24 sm:py-36 bg-[#FAFAF8] border-b border-[#E7E7E4] relative overflow-hidden select-none text-[#111111]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {/* ── CLEAN SANS TYPOGRAPHY MANIFESTO ── */}
        <div className="space-y-4 sm:space-y-6">
          {/* WORD 1: CREATORS. */}
          <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
            <h2 className="text-6xl sm:text-8xl md:text-9xl lg:text-[10.5rem] font-black text-[#111111] tracking-tighter leading-none">
              CREATORS.
            </h2>
          ...
          <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4 md:pl-16">
            <h2 className="text-6xl sm:text-8xl md:text-9xl lg:text-[10.5rem] font-black text-[#6B6B6B] hover:text-[#111111] transition-colors tracking-tighter leading-none">
              BRANDS.
            </h2>

            <div className="max-w-xs text-xs text-[#6B6B6B] leading-relaxed hidden lg:block font-medium">
        ...
        <div className="pt-8 border-t border-[#E7E7E4] flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          <p className="text-base sm:text-lg text-[#111111] font-semibold max-w-2xl">
            From creator discovery and contract QA to timecoded video reviews and instant bank payouts — everything in one modern workflow.
          </p>

          <Link
            href="/for-brands"
            className="inline-flex items-center gap-2 text-xs font-mono font-bold text-[#111111] hover:text-black transition-colors shrink-0 bg-[#FFFFFF] px-4 py-2.5 rounded-[9px] border border-[#E7E7E4] shadow-xs"
          >
