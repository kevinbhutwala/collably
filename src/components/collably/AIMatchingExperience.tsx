...
export function AIMatchingExperience() {
  const presets = [
    "Fitness & calisthenics creators for sponsored YouTube review under $2.5K",
    "Tech & AI storytellers for SaaS launch with verified developer audience",
    "Audio gear & mechanical keyboard reviewers for cinematic showcase",
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 sm:space-y-16 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-pink-500/15 border border-pink-500/30 text-xs font-mono font-bold text-[hsl(327,100%,55%)] shadow-xs">
            ...
            <span>04 • Natural Language Matching</span>
          </div>
          ...
          >
            Precision creator matching by brief.
          </ScrollRevealText>

          <ScrollRevealText
            as="p"
            gradientWords={["describe", "brief", "verified", "rates"]}
            className="text-sm sm:text-lg text-slate-300 font-sans max-w-2xl mx-auto leading-relaxed"
          >
            Type your requirements in plain English. Match creators by verified engagement, audience geography, and transparent rate cards.
          </ScrollRevealText>
        </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              <div className="relative flex-1 w-full">
                ...
                <input
                  ...
                  placeholder="Describe your target creator and campaign budget..."
