        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className="rounded-2xl bg-[#090D1A] border border-white/[0.08] overflow-hidden transition-all duration-300"
              >
                <button
                ...
                >
                  ...
                  <div className="w-8 h-8 rounded-full bg-white/[0.05] border border-white/10 flex items-center justify-center shrink-0 text-slate-300">
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <div className="px-6 pb-6 text-sm text-slate-400 leading-relaxed border-t border-white/[0.05] pt-4 font-sans">
                        {faq.a}
                      </div>
                    </motion.div>
                  )}
