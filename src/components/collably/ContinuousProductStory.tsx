...
const WORKFLOW_STEPS: WorkflowStep[] = [
  {
    ...
    tagline: "Find creators by verified followers, topic, and high-quality video work.",
    description:
      "Skip unvetted DM spam. Search our live creator catalog with verified metrics, audience locations, and clear upfront rate cards.",
    keyBenefits: [
      "Verified engagement rates (no bots or fake numbers)",
      "Filter by audience location (US, UK, India, Global)",
      "Clear upfront pricing and turnaround times",
    ],
    mockupType: "discover",
    icon: Search,
  },
  {
    ...
    category: "MATCHING",
    tagline: "See how well a creator’s audience aligns with your brand’s goals.",
    description:
      "Our system checks past brand collaborations, audience interests, and content topics to help you partner with creators who actually convert.",
    keyBenefits: [
      "Helpful overview of recent creator content",
      "Audience demographic and location match",
      "Clear compatibility ratings for your campaign",
    ],
    mockupType: "match",
    icon: Sparkles,
  },
  {
    id: "step-collaborate",
    stepNum: "03",
    title: "Protected Upfront Payment",
    category: "SAFE PAYMENTS",
    tagline: "Deposit project funds safely before work begins.",
    description:
      "Both parties agree on simple terms. The brand sets aside the budget safely with AbeyCollab before the creator records, so everyone is protected.",
    keyBenefits: [
      "Money is secured upfront so creators know they will be paid",
      "Clear steps from initial idea to final approved video",
      "No waiting 60–90 days for invoices to be paid",
    ],
  ...
  },
  {
    id: "step-review",
    stepNum: "04",
    title: "Simple Video Review",
    category: "REVIEW WORKSPACE",
    tagline: "Watch drafts, share notes, and request small edits easily.",
    description:
      "No more messy email threads or scattered links. Review video drafts directly in your project workspace and leave notes with exact timestamps.",
    keyBenefits: [
      "Pin notes to specific seconds in the video",
      "Clear view of requested edits and new versions",
      "Fair revision limits so projects finish on time",
    ],
    mockupType: "review",
    icon: Video,
  },
  {
    ...
    category: "CLEAR AGREEMENTS",
    tagline: "Approve deliverables and get usage rights instantly.",
    description:
      "When the video looks great, click Approve. Content usage rights and original high-resolution downloads are unlocked right away.",
    keyBenefits: [
      "Clear commercial usage rights included",
      "Easy download of high-resolution master files",
      "Recorded sign-off for both creator and brand",
    ],
    mockupType: "approve",
    icon: FileCheck2,
  },
  {
    ...
    category: "PAYOUTS",
    tagline: "Funds release automatically to the creator's bank account.",
    description:
      "Once you approve, payment is sent immediately. Creators receive 90% of the agreed fee with a clear receipt and transparent breakdown.",
    keyBenefits: [
      "Direct bank transfer via Stripe or Razorpay upon approval",
      "Simple 10% platform fee with zero hidden surprises",
      "Automatic tax receipts and invoices",
    ],
    mockupType: "pay",
    icon: Zap,
  },
  {
    id: "step-grow",
    stepNum: "07",
    title: "Track Results & Re-book",
    category: "LONG-TERM GROWTH",
    tagline: "See what worked and re-hire your best creators with 1 click.",
    description:
      "Review link clicks, views, and campaign performance across all creators. Save top partners to your contacts and work together again easily.",
    keyBenefits: [
      "Clean campaign results dashboard",
      "Compare performance across creators",
      "1-Click re-hiring for ongoing partnerships",
    ],
    mockupType: "grow",
    icon: TrendingUp,
  },
