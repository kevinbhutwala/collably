...
const CREATORS_OVERLAPPING: OverlappingCreatorCard[] = [
  {
    ...
    category: "fashion",
    categoryLabel: "Fashion & Style",
    mainPortrait: "/creators/prarthana.jpg",
    overlappingImage: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=400&auto=format&fit=crop&q=80",
    overlappingBadgeText: "Editorial Styling",
    rateNumber: 450,
    rate: "$450",
    reach: "30K",
    rating: 4.95,
    tags: ["Editorial Fashion", "Visual Aesthetic", "99.1% AI Match"],
  },
  {
    id: "dipti",
    ...
    category: "fashion",
    categoryLabel: "Contemporary Fashion",
    mainPortrait: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800&auto=format&fit=crop&q=80",
    overlappingImage: "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=400&auto=format&fit=crop&q=80",
    overlappingBadgeText: "Lookbook Reel",
    rateNumber: 420,
    rate: "$420",
    reach: "99.3K",
    rating: 4.96,
    tags: ["Contemporary Draping", "Textile Stories", "98.5% AI Match"],
  },
  {
    id: "decodingtech",
    name: "Decoding Tech",
    ...
    mainPortrait: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&auto=format&fit=crop&q=80",
    overlappingImage: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=400&auto=format&fit=crop&q=80",
    overlappingBadgeText: "4K Hardware Test",
    rateNumber: 390,
    rate: "$390",
    reach: "81.9K",
    rating: 4.92,
    tags: ["Smartphones", "EDC Setups", "97.8% AI Match"],
  },
  {
    id: "kushi",
    ...
    category: "lifestyle",
    categoryLabel: "Cinema & Life",
    mainPortrait: "/creators/kushi-hanamsagar.jpg",
    overlappingImage: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400&auto=format&fit=crop&q=80",
    overlappingBadgeText: "Visual Moments",
    rateNumber: 150,
    rate: "$150",
    reach: "869",
    rating: 4.95,
    tags: ["Visual Storytelling", "Cinematic Moments", "98.2% AI Match"],
  },
];
