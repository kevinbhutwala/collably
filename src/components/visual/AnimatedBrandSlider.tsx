...
export function AnimatedBrandSlider({
  ...
  return (
    <div className={`relative w-full overflow-hidden select-none py-6 border-y border-black/8 dark:border-white/10 bg-[#FAF9F5] dark:bg-[#0A0A10] ${className}`}>
      {/* Subtle edge fades */}
      <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#FAF9F5] dark:from-[#0A0A10] to-transparent z-10" />
