...
export function Footer() {
  return (
    <footer className="border-t border-[#E7E7E4] dark:border-white/10 bg-[#FAFAF8] dark:bg-[#07070B] text-[#626262] dark:text-[#8E8EA4] text-xs font-sans">
      {/* Main Footer Links */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-2 md:grid-cols-5 gap-8">
        <div className="col-span-2 space-y-4">
          <AbeyCollabLogo href="/" size="sm" subtext="Creator Commerce" />
        ...
        <div>
          <h4 className="text-xs font-bold uppercase tracking-wider text-[#101010] dark:text-white mb-4 font-mono">
            Platform
          </h4>
          <ul className="space-y-2.5 text-xs font-sans">
            <li><Link href="/creators" className="hover:text-[#101010] dark:hover:text-white transition-colors">Creator Discovery</Link></li>
            <li><Link href="/for-brands" className="hover:text-[#101010] dark:hover:text-white transition-colors">For Brand Marketers</Link></li>
            <li><Link href="/campaigns" className="hover:text-[#101010] dark:hover:text-white transition-colors">Live Briefs</Link></li>
            <li><Link href="/app/collaborations" className="hover:text-[#101010] dark:hover:text-white transition-colors">Video Review Player</Link></li>
            <li><Link href="/pricing" className="hover:text-[#101010] dark:hover:text-white transition-colors">Pricing &amp; 10% Fee</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-xs font-sans">
            <li><Link href="/privacy" className="hover:text-[#101010] dark:hover:text-white transition-colors">Privacy Policy</Link></li>
            <li><Link href="/terms" className="hover:text-[#101010] dark:hover:text-white transition-colors">Terms of Service</Link></li>
            <li><Link href="/dpa" className="hover:text-[#101010] dark:hover:text-white transition-colors">Data Processing (DPA)</Link></li>
            <li><Link href="/refund-policy" className="hover:text-[#101010] dark:hover:text-white transition-colors">Milestone Refund Policy</Link></li>
            <li><Link href="/login" className="hover:text-[#101010] dark:hover:text-white transition-colors font-bold flex items-center gap-1 text-[#101010] dark:text-[#FFD21F]">Sign In <span className="text-[#FFD21F]">→</span></Link></li>
          </ul>
        </div>
      </div>
