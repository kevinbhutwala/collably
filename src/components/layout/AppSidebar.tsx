...
export function AppSidebar() {
  ...
  const creatorNavItems: NavItem[] = [
    ...
    { href: "/app/messages", label: "Chat & Messages", icon: MessageSquare, badge: "1" },
  ...
  const brandNavItems: NavItem[] = [
    ...
    { href: "/app/messages", label: "Chat & Messages", icon: MessageSquare },
