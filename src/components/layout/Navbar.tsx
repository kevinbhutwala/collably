                ...
                {isAuthenticated ? (
                  <div className="flex flex-col gap-2.5 w-full">
                    <div className="flex items-center justify-between p-3 rounded-2xl bg-black/4 dark:bg-white/5 border border-black/5 dark:border-white/10">
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="relative shrink-0">
                          <div className="w-9 h-9 rounded-full bg-[#FFD21F] text-[#0A0A0E] font-black text-sm flex items-center justify-center font-mono">
                            {user?.name?.charAt(0) || "U"}
                          </div>
                    ...
                    <Link
                      href={user?.role === "brand" ? "/app/brand/campaigns" : "/app/dashboard"}
                      onClick={() => setMobileMenuOpen(false)}
                      className="w-full py-3.5 text-center rounded-2xl bg-[#FFD21F] text-[#0A0A0E] text-xs font-extrabold shadow-sm flex items-center justify-center gap-1.5"
                    >
