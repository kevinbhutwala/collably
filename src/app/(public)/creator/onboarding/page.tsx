...
export default function CreatorOnboardingWizardPage() {
  ...
  const { user, setRole, currentCreator, updateCreatorProfile } = useAuthStore();
  ...
  const [formData, setFormData] = useState({
    ...
    portfolioLink: "",
    // Step 6: Services
    services: ["YouTube 60s Integration", "X (Twitter) Thread"],
    // Step 7: Pricing
    startingFee: 1500,
    // Step 8: Availability
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-white dark:bg-[#12121A] border border-black/8 dark:border-white/10 shadow-xs space-y-6 text-[#0A0A0E] dark:text-[#F4F4F8]">
          ...
          {step === 7 && (
            <div className="space-y-4 font-mono text-xs">
              ...
              />
              <p className="text-[11px] text-[#5A5A68] dark:text-[#8E8EA4] font-sans">
