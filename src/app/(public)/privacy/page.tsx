      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="space-y-8 text-sm text-[#6B6B6B] dark:text-[#8E8EA4] leading-relaxed border-t border-[#E7E7E4] dark:border-white/10 pt-8 font-sans font-medium">
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#111111] dark:text-white font-display">1. Overview &amp; Commitment</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#111111] dark:text-white font-display">2. Information We Collect</h2>
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-[#6B6B6B] dark:text-[#8E8EA4]">
              <li><strong className="text-[#111111] dark:text-white">Account Identification:</strong> Legal name, email address, password hash (salted PBKDF2), profile handles, company name, and location.</li>
              <li><strong className="text-[#111111] dark:text-white">Social Media &amp; Audience Analytics:</strong> Public handles, verified follower metrics, subscriber counts, and engagement rates for YouTube, Instagram, TikTok, X, and LinkedIn.</li>
              <li><strong className="text-[#111111] dark:text-white">Campaign Data:</strong> Briefs, deliverable video uploads, timecoded review comments, rate cards, and contract terms.</li>
              <li><strong className="text-[#111111] dark:text-white">Financial Data:</strong> Payout details, escrow transaction IDs, and invoice records processed via secure payment processors (Stripe Connect / Razorpay). We never store raw credit card numbers.</li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#111111] dark:text-white font-display">3. How We Use Your Information</h2>
            <ul className="list-disc pl-5 space-y-1.5 text-[#6B6B6B] dark:text-[#8E8EA4]">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#111111] dark:text-white font-display">4. Data Sharing &amp; Third Parties</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-[#6B6B6B] dark:text-[#8E8EA4]">
              <li><strong className="text-[#111111] dark:text-white">Payment Infrastructure:</strong> Stripe / Razorpay for escrow holding and direct creator bank payouts.</li>
              <li><strong className="text-[#111111] dark:text-white">Transactional Email:</strong> Resend for automated deliverable alerts and milestone status updates.</li>
              <li><strong className="text-[#111111] dark:text-white">Cloud Storage:</strong> Encrypted object storage for 4K video drafts and portfolio media.</li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-xl font-bold text-[#111111] dark:text-white font-display">5. Your Data Rights &amp; Deletion</h2>
            <p>
              You have the right to access, export, update, or permanently delete your account and all associated media kits at any time from your account settings or by contacting our Data Protection Officer at <span className="font-mono text-[#111111] dark:text-white font-bold">privacy@abeycollab.com</span>.
            </p>
          </section>
        </div>
      </div>
