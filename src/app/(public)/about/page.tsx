...
export default function AboutPage() {
  return (
    <div className="bg-[#FAFAF8] dark:bg-[#07070B] text-[#111111] dark:text-[#F4F4F8] min-h-screen">
      <Script
      ...
      <div className="pt-24 pb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
        ...
        <p className="text-base text-[#6B6B6B] dark:text-[#8E8EA4] max-w-2xl mx-auto font-sans font-medium leading-relaxed">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        <div className="p-8 sm:p-12 rounded-2xl bg-[#FFFFFF] dark:bg-[#12121A] border border-[#E7E7E4] dark:border-white/10 shadow-xs space-y-6">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-[#111111] dark:text-white font-display">
            Why traditional influencer marketing is broken
          </h2>
          <p className="text-sm sm:text-base text-[#6B6B6B] dark:text-[#8E8EA4] leading-relaxed font-sans font-medium">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div className="p-8 rounded-2xl bg-[#FFFFFF] dark:bg-[#12121A] border border-[#E7E7E4] dark:border-white/10 hover:border-[#FFD21F] dark:hover:border-[#FFD21F] shadow-xs space-y-3 transition-all">
            ...
            <p className="text-xs text-[#6B6B6B] dark:text-[#8E8EA4] leading-relaxed font-sans font-medium">
