      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 p-6 sm:p-8 rounded-3xl bg-white dark:bg-[#12121A] border border-black/8 dark:border-white/10 shadow-xs space-y-6">
          ...
          {isLoading ? (
            ...
            <div role="table" aria-label="Creator Verification List" className="admin-list divide-y divide-black/5 dark:divide-white/5 space-y-3">
              {creators.map((creator) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="relative w-11 h-11 rounded-2xl overflow-hidden bg-[#F5F5F9] dark:bg-[#181824] border border-black/8 dark:border-white/10 shrink-0">
                      <SafeImage
